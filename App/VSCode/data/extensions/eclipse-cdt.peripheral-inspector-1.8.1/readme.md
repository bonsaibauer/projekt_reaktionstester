...
![Peripheral Inspector](https://github.com/eclipse-cdt-cloud/vscode-peripheral-inspector/raw/HEAD/media/peripheral-inspector.png)

Depending on the context, the following icons may be visible:

| Icon | Use it to |
|------|-----------|
| ![Collapse](https://github.com/eclipse-cdt-cloud/vscode-peripheral-inspector/raw/HEAD/media/CollapseAll.png) | Collapse currently viewed peripherals |
| ![Search](https://github.com/eclipse-cdt-cloud/vscode-peripheral-inspector/raw/HEAD/media/Search.png) | Open search bar to find specific properties |
| ![Refresh](https://github.com/eclipse-cdt-cloud/vscode-peripheral-inspector/raw/HEAD/media/Reload.png) | Refresh the current view |
| ![Export](https://github.com/eclipse-cdt-cloud/vscode-peripheral-inspector/raw/HEAD/media/Export.png) | Export peripheral registers |
| ![Edit](https://github.com/eclipse-cdt-cloud/vscode-peripheral-inspector/raw/HEAD/media/Edit.png) | Update the register value |
...
For more details about the implementation, please check the [Extending Peripheral Inspector](https://github.com/eclipse-cdt-cloud/vscode-peripheral-inspector/blob/HEAD/docs/extending-peripheral-inspector.md) document.
...
Check our [contribution guidelines](https://github.com/eclipse-cdt-cloud/vscode-peripheral-inspector/blob/HEAD/CONTRIBUTING.md) for more info.
